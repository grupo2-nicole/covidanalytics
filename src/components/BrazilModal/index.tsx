        ...
        <section>
            ...
            <TableContainer>
                ...
                <TableBody>
                    ...
                    <TableRow key={index}>
                        ...
                        <TableCell align="right">{(showPercentageProportionalCasesState(info)?.toFixed(2) + "").replace(".", ",")}%</TableCell>
                    </TableRow>
                    ))}
                </TableBody>
                </Table>
            ...
            <TableContainer>
                ...
                <TableBody>
                    ...
                    <TableRow key={index}>
                        <TableCell>{info.state}</TableCell>
                        <TableCell align="right">{(showPercentageProportionalDeathsState(info)?.toFixed(2) + "").replace(".", ",")}%</TableCell>
                    </TableRow>
                    ))}
                </TableBody>
                </Table>
